...
public:
    ...
    double simplePD(double kp, double kd, double Erro, double sample);
...
private:
    uint32_t Time = 0;
    double k1, k2, ka, kp, kd, ki, erro_ant = 0, ef = 0, d_erro = 0, ef_ant = 0, d_ef = 0, d_ef_ant = 0, sample_ant = 1, u = 0, u_ant = 0;
    double Erro = 0, ErroPassado = 0, Ie = 0;
    double pid = 0, integral = 0, aw = 0, pd = 0;
    double limit = 200;
};
